...
def test_weekly_proof_fails_closed_on_adapter_registry_mutation(tmp_path: Path):
    ...
    try:
        ...
        injection = '    "x_mutation": {"cmd": ["python3", "-c", "print(1)"], "env_allowlist": [], "adapter_version": "0.0.0", "description": "x"},\n'
